...
export const Social = () => {
    ...
    return (
        <div className="flex flex-col ml-4 md:ml-12">
            <a aria-label="Link to my Github"href="https://github.com/HacheEV" className="mt-3" target="_blank" rel="noreferrer">
            ...
            <a aria-label="Link to my Linkedin" href="https://www.linkedin.com/in/hector-esquerdo-valverde-8543131a6/" className="mt-3" target="_blank" rel="noreferrer">
            ...
            <a aria-label="Link to my Whatsapp" href="https://wa.me/34623176914" className="mt-3" target="_blank" rel="noreferrer">
