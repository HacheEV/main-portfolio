    ...
    return (
        <>
            ...
            <div className="hidden md:block md:relative z-0 md:mt-20 mx-4 md:w-full md:h-64  md:my-4">
                <div
                    className="absolute z-0 bottom-0 left-0 flex items-center justify-center bg-dark-secondary w-[90%] h-[70%] rounded-md shadow-[2px_3px_9px_0px_rgba(0,0,0,0.3)] shadow-accent-green">
                ...
                <div className="absolute z-20 top-24 right-0 bg-dark-third w-[35%] h-[50%] rounded-md translate-x-7 shadow-md shadow-accent-green lg:translate-x-0">
                    <div className="flex justify-center items-center w-full h-full">
                        <button className="rounded-lg bg-dark-primary font-Montserrat text-1xl text-white font-bold tracking-[0.15em] w-36 h-10 shadow-sm shadow-white">
                            <Link href="/contact">
                                <a> Contact</a>
                            </Link>
                        </button>
