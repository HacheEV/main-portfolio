    ...
    return (
        <div className="flex justify-evenly flex-row-reverse text-white mt-20">
            <div className="relative -mr-40 -mt-12">
                ...
                <Image src={MediumGreen} width={525} height={525} className="z-50 hover:scale-[96%] hover:transition-transform hover:duration-300"/>
            </div>
            <div className="flex flex-col w-1/2 mr-6 pt-2">
                ...
                <p className="font-Montserrat text-2xl leading-10 my-4" >Hola soy Hector. Desarrollador ubicado en España.
                    Creador de productos digitales. <br />Amante de las últimas tecnologías en busca de la mejor experiencia.
                   </p>
                <button className="bg-dark-third font-Montserrat w-40 h-10 mt-9 rounded-[10px] shadow-md hover:shadow-lg shadow-accent-green hover:shadow-accent-green transition-shadow duration-300 ">Descargar CV </button>
            </div>
        </div>
    )
}